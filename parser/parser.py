...
NP -> Det N | N | Det AP N | NP P NP | P NP
VP -> VP NP | V NP PP | V | Adv VP | V Adv | V NP Adv
AP -> Adj | AP Adj
"""
...
def preprocess(sentence):
    ...
    # should be functional but unsure recommended use of nltk word_tokenize function?
...
def np_chunk(tree):
    ...
    for subtree in parented_tree.subtrees():
        # Noun subtrees have NP chunk parents
        if subtree.label() == "N":
